...
const tapparkConfig = {
  ...
  accessToken: normalizeEnvToken(process.env.TAPPARK_ACCESS_TOKEN),
  refreshToken: normalizeEnvToken(process.env.TAPPARK_REFRESH_TOKEN),
